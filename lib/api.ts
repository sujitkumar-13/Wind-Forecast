...
const ACTUAL_API = "https://data.elexon.co.uk/bmrs/api/v1/datasets/FUELHH/stream";
const FORECAST_API = "https://data.elexon.co.uk/bmrs/api/v1/datasets/WINDFOR/stream";
